...
Download TDEECalculator Django Project Boilerplate
--------------------------------------------------
...
This project is named *TDEECalculator*, so if you are using this 
Boilerplate to create your own project, you'll have to change 
the name in a few places:
 
 - *TDEECalculator_project* **folder** (your top project container)
 - *TDEECalculator_project/TDEECalculator* **folder** (your project name)
 - virtual environment names: **tb_dev** and **tb_test** (name them whatever you want)
 - in virtual environments **postactivate** files (see section below), you have to change **TDEECalculator.settings.development** for your **projectname.settings.development**. Same works for the testing environment.
...
You must add the lines: ::
    ...
    export DJANGO_SETTINGS_MODULE="TDEECalculator.settings.development"
...
where you have to add the lines::
    ...
    export DJANGO_SETTINGS_MODULE="TDEECalculator.settings.testing"
    export SECRET_KEY="your_secret_django_key"
...
- in **test_internationalization**, update your languages with the translation of title text, here "Welcome to TDEECalculator!"
